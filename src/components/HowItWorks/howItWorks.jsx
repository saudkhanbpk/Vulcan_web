    ...
    <>
      ...
      >
        <Grid lg={5} md={5} sm={12} xs={12} sx={{ p: { xs: 2 } }}>
          ...
          <Grid lg={12}>
            <Box>
              <Typography variant="h5" color="primary" align="start">
        ...
        >
          <Box sx={{ pb: 15 }}>
            {isSmallScreen && (
              <Divider orientation="horizontal" sx={myStyles.divider} />
            )}
          </Box>
        </Grid>
        ...
        <Grid lg={5} md={5} sm={12} xs={12} sx={{ p: { xs: 2 } }}>
          <Grid lg={12}>
            <Box>
              ...
              <Typography variant="h5" color="primary" align="start" mt={10}>
